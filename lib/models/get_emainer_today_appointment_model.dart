...
//
//     final getExaminertodaysappointment = getExaminertodaysappointmentFromJson(jsonString);

import 'dart:convert';

GetExaminertodaysappointment getExaminertodaysappointmentFromJson(String str) =>
    GetExaminertodaysappointment.fromJson(json.decode(str));

String getExaminertodaysappointmentToJson(GetExaminertodaysappointment data) =>
    json.encode(data.toJson());

class GetExaminertodaysappointment {
  List<Datum>? data;

  GetExaminertodaysappointment({
    this.data,
  });

  GetExaminertodaysappointment copyWith({
    List<Datum>? data,
  }) =>
      GetExaminertodaysappointment(
        data: data ?? this.data,
  ...
  factory GetExaminertodaysappointment.fromJson(Map<String, dynamic> json) =>
      GetExaminertodaysappointment(
        data: json["data"] == null
            ? []
...
class Datum {
  ...
  factory Datum.fromJson(Map<String, dynamic> json) => Datum(
        ...
        treatment: json["treatment"] == null
            ? null
            : DatumTreatment.fromJson(json["treatment"]),
        visit: json["visit"],
...
class DatumTreatment {
  ...
  factory DatumTreatment.fromJson(Map<String, dynamic> json) => DatumTreatment(
        id: json["id"],
